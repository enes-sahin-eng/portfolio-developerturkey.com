...
export const en: Content = {
    ...
    projects: [
      ...
      },
      {
        ...
        image: {
          ...
          alt: "Home screen of the school site: enrollment form and branch selector on the right, program categories below",
          width: 1440,
          height: 900,
        },
      },
      {
        ...
        title: "A tire shop website run from its own admin panel",
        ...
        image: {
          ...
          alt: "Representative visual: home screen of a dark-themed tire shop site, a wheel and tire on the right, headline and call button on the left",
          width: 1440,
          height: 900,
          illustrative: true,
        },
      },
      {
        ...
        image: {
          ...
          alt: "Representative visual: home screen of a light-toned counseling site, a calm sunlit room and an appointment button",
          width: 1440,
          height: 900,
          illustrative: true,
        },
  ...
  contact: {
    ...
    cvLabel: "Download CV",
    cvHref: site.cv.en,
    aside: "Need a website for a small business? You can message me on WhatsApp too.",
    whatsapp: {
      label: "Message on WhatsApp",
      message: "Hi Enes, I am reaching out through your website.",
    },
  },
  ledger: {
